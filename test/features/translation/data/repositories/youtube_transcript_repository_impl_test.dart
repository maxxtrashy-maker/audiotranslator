...
void main() {
  ...
  group('extractTranscript', () {
    test('returns Right with transcript, title and tracks on success', () async {
      when(() => mockDataSource.fetchTranscript(any()))
          .thenAnswer((_) async => (transcript: tTranscript, title: tTitle, tracks: tTracks));
    ...
    test('retries on ServerFailure then succeeds', () async {
      ...
      when(() => mockDataSource.fetchTranscript(any())).thenAnswer((_) async {
        ...
        return (transcript: tTranscript, title: tTitle, tracks: tTracks);
      });
